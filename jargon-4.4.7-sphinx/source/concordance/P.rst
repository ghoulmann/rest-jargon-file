...
backhoe <./F.html#fiber-seeking-backhoe>`__. “I see why you're
...
(see `page out <page-out>`__). Usually confined to the sarcastic
comment: “Eric pages in, `film at 11 <../F.html#film-at-11>`__!”

2. Syn. swap in; see `swap <./S.html#swap>`__.
...
minute.” See `page in <page-in>`__. Compare
`glitch <../G.html#glitch>`__, `thinko <../T.html#thinko>`__.

2. Syn. swap out; see `swap <./S.html#swap>`__.
...
[common] Shorthand for parameter. See also `parm <parm>`__;
compare `arg <./A.html#arg>`__, `var <./V.html#var>`__.
...
Further-compressed form of `param <param>`__. This term is an
*IBMism*, and written use is almost unknown outside IBM shops; spoken
/parm/ is more widely distributed, but the synonym
`arg <./A.html#arg>`__ is favored among hackers. Compare
`arg <./A.html#arg>`__, `var <./V.html#var>`__.
...
language <./B.html#bondage-and-discipline-language>`__). The hackish
...
Kernighan (of `K&R <./K.html#K-ampersand-R>`__ fame) entitled *Why
...
`http://www.lysator.liu.se/c/bwk-on-pascal.html <http://www.lysator.liu.se/c/bwk-on-pascal>`__.)
...
`C <./C.html#C>`__) from the niches it had acquired in serious
...
compare `tits on a keyboard <./T.html#tits-on-a-keyboard>`__.
...
`quick-and-dirty <./Q.html#quick-and-dirty>`__ remedy to an existing
...
from a `diff <./D.html#diff>`__ or `mod <./M.html#mod>`__ by the
...
`HLL <./H.html#HLL>`__. Compare `one-line
fix <./O.html#one-line-fix>`__.

2. vt. To insert a patch into a piece of code.

3. [in the Unix world] n. A `diff <./D.html#diff>`__ (sense 2).
...
`trap door <./T.html#trap-door>`__\ s or any way to penetrate
...
`patch <patch>`__ (sense 4), `zap <./Z.html#zap>`__ (sense 4),
`hook <./H.html#hook>`__.
...
1. A `bang path <./B.html#bang-path>`__ or explicitly routed Internet
...
specifying the directories in which the `shell <./S.html#shell>`__
...
Commercial software. Oppose `shareware <./S.html#shareware>`__ or
`freeware <./F.html#freeware>`__.
...
short-sighted programmer. Compare `UBD <./U.html#UBD>`__; see also
...
distributed over `Usenet <./U.html#Usenet>`__ and from Internet
...
and use rights to anyone who can `snarf <./S.html#snarf>`__ a copy.
See `copyleft <./C.html#copyleft>`__.
...
`timesharing <./T.html#timesharing>`__ real. It looms large in hacker
...
eventually eclipsed by the `VAX <./V.html#VAX>`__ machines
(descendants of the `PDP-11 <PDP-11>`__) when
`DEC <./D.html#DEC>`__ recognized that the 10 and
`VAX <./V.html#VAX>`__ product lines were competing with each other
and decided to concentrate its software development effort on the more
profitable `VAX <./V.html#VAX>`__. The machine was finally dropped
...
market clones came to nothing; see `Foonly <./F.html#Foonly>`__ and
`Mars <./M.html#Mars>`__.) This event spelled the doom of
`ITS <./I.html#ITS>`__ and the technical cultures that had spawned
...
on a PDP-10. See `TOPS-10 <./T.html#TOPS-10>`__,
`ITS <./I.html#ITS>`__, `BLT <./B.html#BLT>`__,
`DDT <./D.html#DDT>`__, `EXCH <./E.html#EXCH>`__,
`HAKMEM <./H.html#HAKMEM>`__, `pop <pop>`__,
`push <push>`__. See also
...
`DEC <./D.html#DEC>`__; the last (11/93 and 11/94) in 1990. Along the
way, the 11 gave birth to the `VAX <./V.html#VAX>`__, strongly
...
The most famous computer that never was. `PDP-10 <PDP-10>`__
computers running the `TOPS-10 <./T.html#TOPS-10>`__ operating system
were labeled ‘DECsystem-10’ as a way of differentiating them from the
`PDP-11 <PDP-11>`__. Later on, those systems running
`TOPS-20 <./T.html#TOPS-20>`__ were labeled ‘DECSYSTEM-20’ (the block
...
errors that even a `luser <./L.html#luser>`__ could figure out. Very
...
PEBKAC”. See also `ID10T <./I.html#idiot>`__. Compare `pilot
error <pilot-error>`__, `UBD <./U.html#UBD>`__.
...
or (most likely) total `lossage <./L.html#lossage>`__ (see `killer
poke <./K.html#killer-poke>`__).

Since a `real operating system <./R.html#real-operating-system>`__
...
is diagnostic of the `newbie <./N.html#newbie>`__. (Of course, OS
...
implying that the chip is inherently `evil <./E.html#evil>`__. Often
...
A person with no special (`root <./R.html#root>`__ or
`wheel <./W.html#wheel>`__) privileges on a computer system. “I can't
...
solving `toy problem <./T.html#toy-problem>`__\ s). “Of course my
...
Syn. `chad <./C.html#chad>`__ (sense 1). The term perfory
/per´f@-ree/ is also heard. The term `perf <perf>`__ may also
...
`awk <./A.html#awk>`__, but is much hairier, including many
...
choice <./L.html#languages-of-choice>`__, and it is by far the most
...
`Swiss-Army chainsaw <./S.html#Swiss-Army-chainsaw>`__ of Unix
programming. Though Perl is very useful, it would be a stretch to
describe it as pretty or `elegant <./E.html#elegant>`__; people who
like clean, spare design generally prefer `Python <Python>`__.
See also `Camel Book <./C.html#Camel-Book>`__,
`TMTOWTDI <./T.html#TMTOWTDI>`__.
...
with no `network address <./N.html#network-address>`__, frequently to
...
Compare `return from the dead <./R.html#return-from-the-dead>`__.
...
[Usenet; common, originally from the `BOFH <./B.html#BOFH>`__ mythos]
Abbreviation for Pimply-Faced Youth. A `BOFH <./B.html#BOFH>`__ in
...
ways; esp. one that propagates a `virus <./V.html#virus>`__ or
`Trojan horse <./T.html#Trojan-horse>`__. See also
`worm <./W.html#worm>`__, `mockingbird <./M.html#mockingbird>`__.
...
going to `wrap around <./W.html#wrap-around>`__ to the day schedule
...
around <./W.html#wrap-around>`__). The ‘jet lag’ that afflicts
...
See also `heisenbug <./H.html#heisenbug>`__.
...
`barf <./B.html#barf>`__. The length of the first line depended on
...
[MIT] Syn. `wrap around <./W.html#wrap-around>`__, sense 2.
...
the `Dilbert <./D.html#Dilbert>`__ character, the archetypal
halfwitted middle-`management <./M.html#management>`__ type. See also
`pointy-haired <pointy-haired>`__.
...
One who engages in `phreaking <phreaking>`__. See also `blue
box <./B.html#blue-box>`__.
...
1. The art and science of `cracking <./C.html#cracking>`__ the phone
...
`nano- <./N.html#nano->`__; used in the same rather loose connotative
way as `nano- <./N.html#nano->`__ and
`micro- <./M.html#micro->`__. This usage is not yet common in the way
`nano- <./N.html#nano->`__ and `micro- <./M.html#micro->`__ are,
...
`UBD <./U.html#UBD>`__). “Joe Luser reported a bug in sendmail that
causes it to generate bogus headers.” “That's not a bug, that's pilot
error. His **sendmail.cf** is hosed.” Compare
`PEBKAC <PEBKAC>`__, `UBD <./U.html#UBD>`__,
`ID10T <./I.html#idiot>`__.
...
as a phone greeting. See `ACK <./A.html#ACK>`__, also
`ENQ <./E.html#ENQ>`__.
...
list <./M.html#mailing-list>`__ requesting an
`ACK <./A.html#ACK>`__ (in order to verify that everybody's addresses
...
than just “ping”!). Oppose `blargh <./B.html#blargh>`__.
...
A notorious `exploit <./E.html#exploit>`__ that (when first
...
`http://www.insecure.org/sploits/ping-o-death.html <http://www.insecure.org/sploits/ping-o-death>`__.
Compare `kamikaze packet <./K.html#kamikaze-packet>`__ and 'Chernobyl
packet.'
...
A form of `DoS attack <./D.html#DoS-attack>`__ consisting of a flood
of `ping <ping>`__ requests (normally used to check network
...
storm <./M.html#mail-storm>`__, `broadcast
storm <./B.html#broadcast-storm>`__.
...
wire <./B.html#blue-wire>`__, but used in military applications.
...
valuable data in the process of `crunch <./C.html#crunch>`__\ ing it.
...
`memory smash <./M.html#memory-smash>`__\ es overwrite the control
...
`X <./X.html#X>`__ demos induce plaid-screen effects deliberately as
a `display hack <./D.html#display-hack>`__.
...
Syn. `flat-ASCII <./F.html#flat-ASCII>`__.
...
[Unix] On systems that support `finger <./F.html#finger>`__, the
...
purposes (like a `sig block <./S.html#sig-block>`__). See also
`Hacking X for Y <./H.html#Hacking-X-for-Y>`__.
...
`finger <./F.html#finger>`__ command will (for security reasons; see
`letterbomb <./L.html#letterbomb>`__) not pass the escape character.
...
`twirling baton <./T.html#twirling-baton>`__.
...
16 bits, by analogy with `nybble <./N.html#nybble>`__ and
`byte <./B.html#byte>`__. Usage: rare and extremely silly. See also
`dynner <./D.html#dynner>`__ and `crumb <./C.html#crumb>`__.
...
Yiddish *schmuck*)] The sound a `newbie <./N.html#newbie>`__ makes as
he falls to the bottom of a `kill file <./K.html#kill-file>`__. While
it originated in the `newsgroup <./N.html#newsgroup>`__
...
[from the `ADVENT <./A.html#ADVENT>`__ game] See
`xyzzy <./X.html#xyzzy>`__.
...
[Unix] Term used for `shell <./S.html#shell>`__ code, so called
...
plumbing (see `hairy <./H.html#hairy>`__). “You can kluge together a
basic spell-checker out of sort(1), comm(1), and tr(1) with a little
plumbing.” See also `tee <./T.html#tee>`__.
...
maintenance <provocative-maintenance>`__; see also `scratch
monkey <./S.html#scratch-monkey>`__.

2. n. Abbrev. for ‘Presentation Manager’, an
`elephantine <./E.html#elephantine>`__ OS/2 graphical user interface.
...
us <./F.html#for-the-rest-of-us>`__, `WIMP
environment <./W.html#WIMP-environment>`__,
`Macintrash <./M.html#Macintrash>`__, `drool-proof
paper <./D.html#drool-proof-paper>`__. Also point-and-grunt interface.
...
used with respect to `open source <./O.html#open-source>`__ projects
being developed in `bazaar <./B.html#bazaar>`__ mode.
...
[after the character in the `Dilbert <./D.html#Dilbert>`__ comic
strip] Describes the extreme form of the property that separates
`suit <./S.html#suit>`__\ s and
`marketroid <./M.html#marketroid>`__\ s from hackers. Compare
`brain-dead <./B.html#brain-dead>`__;
`demented <./D.html#demented>`__; see `PHB <PHB>`__. Always
...
See `wizard hat <./W.html#wizard-hat>`__. This synonym specifically
...
moon <phase-of-the-moon>`__. Usage: usually in the phrase
POM-dependent, which means `flaky <./F.html#flaky>`__.
...
1. vt. To remove something from a `stack <./S.html#stack>`__. If a
...
[from French *poseur*] A `wannabee <./W.html#wannabee>`__; not hacker
slang, but used among crackers, phreaks and `warez
d00dz <./W.html#warez-d00dz>`__. Not as negative as
`lamer <./L.html#lamer>`__ or `leech <./L.html#leech>`__. Probably
...
A kind of `shareware <./S.html#shareware>`__ that borders on
`freeware <./F.html#freeware>`__, in that the author requests only
...
[proposed] Several of the key Internet `RFC <./R.html#RFC>`__\ s,
...
To send a message to a `mailing list <./M.html#mailing-list>`__ or
`newsgroup <./N.html#newsgroup>`__. Distinguished in context from
...
Noun corresp. to v.: `post <post>`__ (but note that
`post <post>`__ can be nouned). Distinguished from a ‘letter’ or
ordinary `email <./E.html#email>`__ message by the fact that it is
...
`admin <./A.html#admin>`__. The Internet standard for electronic mail
(`RFC <./R.html#RFC>`__-822) requires each machine to have a
...
and Martin’, Martin Newell) at `XEROX PARC <./X.html#XEROX-PARC>`__,
...
parallels `EMACS <./E.html#EMACS>`__, which exploited a similar
...
`hung <./H.html#hung>`__ or `gronk <./G.html#gronk>`__\ ed state.
See also `Big Red Switch <./B.html#Big-Red-Switch>`__. Compare
`Vulcan nerve pinch <./V.html#Vulcan-nerve-pinch>`__,
`bounce <./B.html#bounce>`__ (sense 4), and
`boot <./B.html#boot>`__, and see the `Some AI
Koans <../koans>`__ (in Appendix A) about Tom Knight and the
novice.
...
`glitch <./G.html#glitch>`__. These can cause crashes and even
...
term comes from the `warez kiddies <./W.html#warez-kiddies>`__
...
Compare `filk <./F.html#filk>`__, `grilf <./G.html#grilf>`__,
`hing <./H.html#hing>`__ and `newsfroup <./N.html#newsfroup>`__.
...
`baroque <./B.html#baroque>`__ precedence hierarchy and parenthesize
defensively). Can always be avoided by suitable use of parentheses.
`LISP <./L.html#LISP>`__ fans enjoy pointing out that this can't
...
bug <./A.html#aliasing-bug>`__, `memory
leak <./M.html#memory-leak>`__, `memory
smash <./M.html#memory-smash>`__, `smash the
stack <./S.html#smash-the-stack>`__, `fandango on
core <./F.html#fandango-on-core>`__, `overrun
...
`hairy <./H.html#hairy>`__ internal representation; esp. used for the
process of `grind <./G.html#grind>`__\ ing (sense 1) program code,
...
`night mode <./N.html#night-mode>`__ hacking. The term fell into
...
run <./H.html#hacking-run>`__\ s has changed not a bit.
...
programming language constructs like `C <./C.html#C>`__'s printf(3).
See senses 1 and 2 of `tty <./T.html#tty>`__.
...
yank one right out of `hack mode <./H.html#hack-mode>`__. Classically
used to describe being dragged away by an `SO <./S.html#SO>`__ for
...
`NMI <./N.html#NMI>`__ (non-maskable interrupt), especially in
PC-land.
...
`hardcoded <./H.html#hardcoded>`__ choices (see also `dot
file <./D.html#dot-file>`__, `rc file <./R.html#rc-file>`__).

2. [techspeak] A report on the amounts of time spent in each routine of
a program, used to find and `tune <./T.html#tune>`__ away the `hot
spot <./H.html#hot-spot>`__\ s in it. This sense is often verbed. Some
...
program <./T.html#toy-program>`__, `noddy <./N.html#noddy>`__,
`one-liner wars <./O.html#one-liner-wars>`__.
...
Used by hackers, this is syn. with `geek <./G.html#geek>`__.
...
1. In `marketroid <./M.html#marketroid>`__-speak, superior; implies a
...
`handshaking <./H.html#handshaking>`__, `do
protocol <./D.html#do-protocol>`__.
...
performed by a `field servoid <./F.html#field-servoid>`__ who doesn't
...
[Unix] A `daemon <./D.html#daemon>`__ that is run periodically
(typically once a week) to seek out and erase
`core <./C.html#core>`__ files, truncate administrative logfiles,
nuke **lost+found** directories, and otherwise clean up the
`cruft <./C.html#cruft>`__ that tends to pile up in the corners of a
file system. See also `reaper <./R.html#reaper>`__,
`skulker <./S.html#skulker>`__.
...
1. An electronic-mail or `Usenet <./U.html#Usenet>`__ persona adopted
...
`B1FF <./B.html#B1FF>`__. See also
`tentacle <./T.html#tentacle>`__.

2. Notionally, a `flamage <./F.html#flamage>`__-generating AI program
...
Press <./D.html#Dissociated-Press>`__). A significant number of people
...
A `suit <./S.html#suit>`__ wannabee; a hacker who has decided that he
...
also `lobotomy <./L.html#lobotomy>`__.
...
[UK] Syn. `display hack <./D.html#display-hack>`__. See also
`smoking clover <./S.html#smoking-clover>`__.
...
`bogon <./B.html#bogon>`__; see also `quantum
bogodynamics <./Q.html#quantum-bogodynamics>`__. —ESR]
...
the default location for `SEX <./S.html#SEX>`__ (sense 1). “I'll have
...
`huff <./H.html#huff>`__, see `inflate <./I.html#inflate>`__.
...
Syn. for `pumpkin holder <pumpkin-holder>`__; see `patch
pumpkin <patch-pumpkin>`__.
...
See `patch pumpkin <patch-pumpkin>`__.
...
`Stone Age <./S.html#Stone-Age>`__, now obsolescent. The punched card
...
`chad <./C.html#chad>`__, `chad box <./C.html#chad-box>`__,
`eighty-column mind <./E.html#eighty-column-mind>`__, `green
card <./G.html#green-card>`__, `dusty
deck <./D.html#dusty-deck>`__, `code
...
Thing <./R.html#Right-Thing>`__ is and resort to an inefficient hack.
...
2. Syn. `Wizard Book <./W.html#Wizard-Book>`__. Donald Lewine's
*POSIX Programmer's Guide* (O'Reilly, 1991, ISBN 0-937175-73-0). See
also `book titles <./B.html#book-titles>`__.
...
yellow.... Compare `blue wire <./B.html#blue-wire>`__, `yellow
wire <./Y.html#yellow-wire>`__, and `red
wire <./R.html#red-wire>`__.
...
1. To put something onto a `stack <./S.html#stack>`__. If one says
...
later. Antonym of `pop <pop>`__; see also
...
`Perl <Perl>`__, that is). Python's design is notably clean,
...
`BSD <./B.html#BSD>`__ community's relationship to
`Linux <./L.html#Linux>`__ — it's the smaller party in a (usually
...
`Guido <./G.html#Guido>`__, `BDFL <./B.html#BDFL>`__.
