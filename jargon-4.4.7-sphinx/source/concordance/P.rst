...
backhoe <./F.html#fiber-seeking-backhoe.html>`__. “I see why you're
...
2. Syn. swap in; see `swap <./S.html#swap.html>`__.
...
2. Syn. swap out; see `swap <./S.html#swap.html>`__.
...
compare `arg <./A.html#arg.html>`__, `var <./V.html#var.html>`__.
...
`arg <./A.html#arg.html>`__ is favored among hackers. Compare
`arg <./A.html#arg.html>`__, `var <./V.html#var.html>`__.
...
language <./B.html#bondage-and-discipline-language.html>`__). The hackish
...
Kernighan (of `K&R <./K.html#K-ampersand-R.html>`__ fame) entitled *Why
...
`C <./C.html#C.html>`__) from the niches it had acquired in serious
...
compare `tits on a keyboard <./T.html#tits-on-a-keyboard.html>`__.
...
`quick-and-dirty <./Q.html#quick-and-dirty.html>`__ remedy to an existing
...
from a `diff <./D.html#diff.html>`__ or `mod <./M.html#mod.html>`__ by the
...
`HLL <./H.html#HLL.html>`__. Compare `one-line
fix <./O.html#one-line-fix.html>`__.

2. vt. To insert a patch into a piece of code.

3. [in the Unix world] n. A `diff <./D.html#diff.html>`__ (sense 2).
...
There is a classic story of a `tiger team <./T.html#tiger-team.html>`__
...
`trap door <./T.html#trap-door.html>`__\ s or any way to penetrate
...
`patch <patch.html>`__ (sense 4), `zap <./Z.html#zap.html>`__ (sense 4),
...
1. A `bang path <./B.html#bang-path.html>`__ or explicitly routed Internet
...
specifying the directories in which the `shell <./S.html#shell.html>`__
...
Commercial software. Oppose `shareware <./S.html#shareware.html>`__ or
`freeware <./F.html#freeware.html>`__.
...
short-sighted programmer. Compare `UBD <./U.html#UBD.html>`__; see also
...
distributed over `Usenet <./U.html#Usenet.html>`__ and from Internet
...
and use rights to anyone who can `snarf <./S.html#snarf.html>`__ a copy.
See `copyleft <./C.html#copyleft.html>`__.
...
`timesharing <./T.html#timesharing.html>`__ real. It looms large in hacker
...
eventually eclipsed by the `VAX <./V.html#VAX.html>`__ machines
(descendants of the `PDP-11 <PDP-11.html>`__) when
`DEC <./D.html#DEC.html>`__ recognized that the 10 and
`VAX <./V.html#VAX.html>`__ product lines were competing with each other
and decided to concentrate its software development effort on the more
profitable `VAX <./V.html#VAX.html>`__. The machine was finally dropped
...
market clones came to nothing; see `Foonly <./F.html#Foonly.html>`__ and
`Mars <./M.html#Mars.html>`__.) This event spelled the doom of
`ITS <./I.html#ITS.html>`__ and the technical cultures that had spawned
...
on a PDP-10. See `TOPS-10 <./T.html#TOPS-10.html>`__,
`ITS <./I.html#ITS.html>`__, `BLT <./B.html#BLT.html>`__,
`DDT <./D.html#DDT.html>`__, `EXCH <./E.html#EXCH.html>`__,
`HAKMEM <./H.html#HAKMEM.html>`__, `pop <pop.html>`__,
...
`DEC <./D.html#DEC.html>`__; the last (11/93 and 11/94) in 1990. Along the
way, the 11 gave birth to the `VAX <./V.html#VAX.html>`__, strongly
...
computers running the `TOPS-10 <./T.html#TOPS-10.html>`__ operating system
were labeled ‘DECsystem-10’ as a way of differentiating them from the
`PDP-11 <PDP-11.html>`__. Later on, those systems running
`TOPS-20 <./T.html#TOPS-20.html>`__ were labeled ‘DECSYSTEM-20’ (the block
...
errors that even a `luser <./L.html#luser.html>`__ could figure out. Very
...
PEBKAC”. See also `ID10T <./I.html#idiot.html>`__. Compare `pilot
error <pilot-error.html>`__, `UBD <./U.html#UBD.html>`__.
...
`HLL <./H.html#HLL.html>`__ (peek reads memory, poke modifies it). Much
...
or (most likely) total `lossage <./L.html#lossage.html>`__ (see `killer
poke <./K.html#killer-poke.html>`__).

Since a `real operating system <./R.html#real-operating-system.html>`__
...
is diagnostic of the `newbie <./N.html#newbie.html>`__. (Of course, OS
...
implying that the chip is inherently `evil <./E.html#evil.html>`__. Often
...
A person with no special (`root <./R.html#root.html>`__ or
`wheel <./W.html#wheel.html>`__) privileges on a computer system. “I can't
...
solving `toy problem <./T.html#toy-problem.html>`__\ s). “Of course my
...
Syn. `chad <./C.html#chad.html>`__ (sense 1). The term perfory
...
`awk <./A.html#awk.html>`__, but is much hairier, including many
...
choice <./L.html#languages-of-choice.html>`__, and it is by far the most
...
`Swiss-Army chainsaw <./S.html#Swiss-Army-chainsaw.html>`__ of Unix
programming. Though Perl is very useful, it would be a stretch to
describe it as pretty or `elegant <./E.html#elegant.html>`__; people who
like clean, spare design generally prefer `Python <Python.html>`__.
See also `Camel Book <./C.html#Camel-Book.html>`__,
`TMTOWTDI <./T.html#TMTOWTDI.html>`__.
...
with no `network address <./N.html#network-address.html>`__, frequently to
...
Compare `return from the dead <./R.html#return-from-the-dead.html>`__.
...
[Usenet; common, originally from the `BOFH <./B.html#BOFH.html>`__ mythos]
Abbreviation for Pimply-Faced Youth. A `BOFH <./B.html#BOFH.html>`__ in
...
ways; esp. one that propagates a `virus <./V.html#virus.html>`__ or
`Trojan horse <./T.html#Trojan-horse.html>`__. See also
`worm <./W.html#worm.html>`__, `mockingbird <./M.html#mockingbird.html>`__.
...
going to `wrap around <./W.html#wrap-around.html>`__ to the day schedule
...
around <./W.html#wrap-around.html>`__). The ‘jet lag’ that afflicts
...
See also `heisenbug <./H.html#heisenbug.html>`__.
...
`barf <./B.html#barf.html>`__. The length of the first line depended on
...
[MIT] Syn. `wrap around <./W.html#wrap-around.html>`__, sense 2.
...
the `Dilbert <./D.html#Dilbert.html>`__ character, the archetypal
halfwitted middle-`management <./M.html#management.html>`__ type. See also
...
1. The art and science of `cracking <./C.html#cracking.html>`__ the phone
...
`cracking <./C.html#cracking.html>`__).
...
`nano- <./N.html#nano-.html>`__; used in the same rather loose connotative
way as `nano- <./N.html#nano-.html>`__ and
`micro- <./M.html#micro-.html>`__. This usage is not yet common in the way
`nano- <./N.html#nano-.html>`__ and `micro- <./M.html#micro-.html>`__ are,
...
`UBD <./U.html#UBD.html>`__). “Joe Luser reported a bug in sendmail that
causes it to generate bogus headers.” “That's not a bug, that's pilot
error. His **sendmail.cf** is hosed.” Compare
`PEBKAC <PEBKAC.html>`__, `UBD <./U.html#UBD.html>`__,
`ID10T <./I.html#idiot.html>`__.
...
as a phone greeting. See `ACK <./A.html#ACK.html>`__, also
`ENQ <./E.html#ENQ.html>`__.
...
list <./M.html#mailing-list.html>`__ requesting an
`ACK <./A.html#ACK.html>`__ (in order to verify that everybody's addresses
...
than just “ping”!). Oppose `blargh <./B.html#blargh.html>`__.
...
A notorious `exploit <./E.html#exploit.html>`__ that (when first
...
Compare `kamikaze packet <./K.html#kamikaze-packet.html>`__ and 'Chernobyl
packet.'
...
A form of `DoS attack <./D.html#DoS-attack.html>`__ consisting of a flood
...
storm <./M.html#mail-storm.html>`__, `broadcast
storm <./B.html#broadcast-storm.html>`__.
...
wire <./B.html#blue-wire.html>`__, but used in military applications.
...
valuable data in the process of `crunch <./C.html#crunch.html>`__\ ing it.
...
`bogo-sort <./B.html#bogo-sort.html>`__.
...
`memory smash <./M.html#memory-smash.html>`__\ es overwrite the control
...
`X <./X.html#X.html>`__ demos induce plaid-screen effects deliberately as
a `display hack <./D.html#display-hack.html>`__.
...
Syn. `flat-ASCII <./F.html#flat-ASCII.html>`__.
...
[Unix] On systems that support `finger <./F.html#finger.html>`__, the
...
purposes (like a `sig block <./S.html#sig-block.html>`__). See also
`Hacking X for Y <./H.html#Hacking-X-for-Y.html>`__.
...
`finger <./F.html#finger.html>`__ command will (for security reasons; see
`letterbomb <./L.html#letterbomb.html>`__) not pass the escape character.
...
mines <./S.html#salt-mines.html>`__.
...
16 bits, by analogy with `nybble <./N.html#nybble.html>`__ and
`byte <./B.html#byte.html>`__. Usage: rare and extremely silly. See also
`dynner <./D.html#dynner.html>`__ and `crumb <./C.html#crumb.html>`__.
...
Yiddish *schmuck*)] The sound a `newbie <./N.html#newbie.html>`__ makes as
he falls to the bottom of a `kill file <./K.html#kill-file.html>`__. While
it originated in the `newsgroup <./N.html#newsgroup.html>`__
...
[from the `ADVENT <./A.html#ADVENT.html>`__ game] See
`xyzzy <./X.html#xyzzy.html>`__.
...
[Unix] Term used for `shell <./S.html#shell.html>`__ code, so called
...
plumbing (see `hairy <./H.html#hairy.html>`__). “You can kluge together a
basic spell-checker out of sort(1), comm(1), and tr(1) with a little
plumbing.” See also `tee <./T.html#tee.html>`__.
...
monkey <./S.html#scratch-monkey.html>`__.

2. n. Abbrev. for ‘Presentation Manager’, an
`elephantine <./E.html#elephantine.html>`__ OS/2 graphical user interface.
...
us <./F.html#for-the-rest-of-us.html>`__, `WIMP
environment <./W.html#WIMP-environment.html>`__,
`Macintrash <./M.html#Macintrash.html>`__, `drool-proof
paper <./D.html#drool-proof-paper.html>`__. Also point-and-grunt interface.
...
used with respect to `open source <./O.html#open-source.html>`__ projects
being developed in `bazaar <./B.html#bazaar.html>`__ mode.
...
[after the character in the `Dilbert <./D.html#Dilbert.html>`__ comic
strip] Describes the extreme form of the property that separates
`suit <./S.html#suit.html>`__\ s and
`marketroid <./M.html#marketroid.html>`__\ s from hackers. Compare
`brain-dead <./B.html#brain-dead.html>`__;
`demented <./D.html#demented.html>`__; see `PHB <PHB.html>`__. Always
...
See `wizard hat <./W.html#wizard-hat.html>`__. This synonym specifically
...
POM-dependent, which means `flaky <./F.html#flaky.html>`__.
...
1. vt. To remove something from a `stack <./S.html#stack.html>`__. If a
...
[from French *poseur*] A `wannabee <./W.html#wannabee.html>`__; not hacker
slang, but used among crackers, phreaks and `warez
d00dz <./W.html#warez-d00dz.html>`__. Not as negative as
`lamer <./L.html#lamer.html>`__ or `leech <./L.html#leech.html>`__. Probably
...
A kind of `shareware <./S.html#shareware.html>`__ that borders on
`freeware <./F.html#freeware.html>`__, in that the author requests only
...
[proposed] Several of the key Internet `RFC <./R.html#RFC.html>`__\ s,
...
To send a message to a `mailing list <./M.html#mailing-list.html>`__ or
`newsgroup <./N.html#newsgroup.html>`__. Distinguished in context from
...
ordinary `email <./E.html#email.html>`__ message by the fact that it is
...
`admin <./A.html#admin.html>`__. The Internet standard for electronic mail
(`RFC <./R.html#RFC.html>`__-822) requires each machine to have a
...
and Martin’, Martin Newell) at `XEROX PARC <./X.html#XEROX-PARC.html>`__,
...
parallels `EMACS <./E.html#EMACS.html>`__, which exploited a similar
...
Syn. `bang on <./B.html#bang-on.html>`__.
...
`hung <./H.html#hung.html>`__ or `gronk <./G.html#gronk.html>`__\ ed state.
See also `Big Red Switch <./B.html#Big-Red-Switch.html>`__. Compare
`Vulcan nerve pinch <./V.html#Vulcan-nerve-pinch.html>`__,
`bounce <./B.html#bounce.html>`__ (sense 4), and
`boot <./B.html#boot.html>`__, and see the `Some AI
...
`glitch <./G.html#glitch.html>`__. These can cause crashes and even
...
term comes from the `warez kiddies <./W.html#warez-kiddies.html>`__
...
Compare `filk <./F.html#filk.html>`__, `grilf <./G.html#grilf.html>`__,
`hing <./H.html#hing.html>`__ and `newsfroup <./N.html#newsfroup.html>`__.
...
`baroque <./B.html#baroque.html>`__ precedence hierarchy and parenthesize
defensively). Can always be avoided by suitable use of parentheses.
`LISP <./L.html#LISP.html>`__ fans enjoy pointing out that this can't
...
bug <./A.html#aliasing-bug.html>`__, `memory
leak <./M.html#memory-leak.html>`__, `memory
smash <./M.html#memory-smash.html>`__, `smash the
stack <./S.html#smash-the-stack.html>`__, `fandango on
core <./F.html#fandango-on-core.html>`__, `overrun
...
`numbers <./N.html#numbers.html>`__. Interesting graphical output from a
...
`hairy <./H.html#hairy.html>`__ internal representation; esp. used for the
process of `grind <./G.html#grind.html>`__\ ing (sense 1) program code,
...
[Mac users] See `feature key <./F.html#feature-key.html>`__.
...
`night mode <./N.html#night-mode.html>`__ hacking. The term fell into
...
run <./H.html#hacking-run.html>`__\ s has changed not a bit.
...
programming language constructs like `C <./C.html#C.html>`__'s printf(3).
See senses 1 and 2 of `tty <./T.html#tty.html>`__.
...
yank one right out of `hack mode <./H.html#hack-mode.html>`__. Classically
used to describe being dragged away by an `SO <./S.html#SO.html>`__ for
...
`NMI <./N.html#NMI.html>`__ (non-maskable interrupt), especially in
PC-land.
...
`hardcoded <./H.html#hardcoded.html>`__ choices (see also `dot
file <./D.html#dot-file.html>`__, `rc file <./R.html#rc-file.html>`__).

2. [techspeak] A report on the amounts of time spent in each routine of
a program, used to find and `tune <./T.html#tune.html>`__ away the `hot
spot <./H.html#hot-spot.html>`__\ s in it. This sense is often verbed. Some
...
`geekasm <./G.html#geekasm.html>`__.
...
as an RPM or `tarball <./T.html#tarball.html>`__.
...
program <./T.html#toy-program.html>`__, `noddy <./N.html#noddy.html>`__,
`one-liner wars <./O.html#one-liner-wars.html>`__.
...
`wirewater <./W.html#wirewater.html>`__.
...
Used by hackers, this is syn. with `geek <./G.html#geek.html>`__.
...
1. In `marketroid <./M.html#marketroid.html>`__-speak, superior; implies a
...
`handshaking <./H.html#handshaking.html>`__, `do
protocol <./D.html#do-protocol.html>`__.
...
performed by a `field servoid <./F.html#field-servoid.html>`__ who doesn't
...
[Unix] A `daemon <./D.html#daemon.html>`__ that is run periodically
(typically once a week) to seek out and erase
`core <./C.html#core.html>`__ files, truncate administrative logfiles,
nuke **lost+found** directories, and otherwise clean up the
`cruft <./C.html#cruft.html>`__ that tends to pile up in the corners of a
file system. See also `reaper <./R.html#reaper.html>`__,
`skulker <./S.html#skulker.html>`__.
...
1. An electronic-mail or `Usenet <./U.html#Usenet.html>`__ persona adopted
...
`B1FF <./B.html#B1FF.html>`__. See also
`tentacle <./T.html#tentacle.html>`__.

2. Notionally, a `flamage <./F.html#flamage.html>`__-generating AI program
...
Press <./D.html#Dissociated-Press.html>`__). A significant number of people
...
A `suit <./S.html#suit.html>`__ wannabee; a hacker who has decided that he
...
also `lobotomy <./L.html#lobotomy.html>`__.
...
[UK] Syn. `display hack <./D.html#display-hack.html>`__. See also
`smoking clover <./S.html#smoking-clover.html>`__.
...
`bogon <./B.html#bogon.html>`__; see also `quantum
bogodynamics <./Q.html#quantum-bogodynamics.html>`__. —ESR]
...
the default location for `SEX <./S.html#SEX.html>`__ (sense 1). “I'll have
...
`huff <./H.html#huff.html>`__, see `inflate <./I.html#inflate.html>`__.
...
`Stone Age <./S.html#Stone-Age.html>`__, now obsolescent. The punched card
...
`chad <./C.html#chad.html>`__, `chad box <./C.html#chad-box.html>`__,
`eighty-column mind <./E.html#eighty-column-mind.html>`__, `green
card <./G.html#green-card.html>`__, `dusty
deck <./D.html#dusty-deck.html>`__, `code
grinder <./C.html#code-grinder.html>`__.
...
Thing <./R.html#Right-Thing.html>`__ is and resort to an inefficient hack.
...
2. Syn. `Wizard Book <./W.html#Wizard-Book.html>`__. Donald Lewine's
*POSIX Programmer's Guide* (O'Reilly, 1991, ISBN 0-937175-73-0). See
also `book titles <./B.html#book-titles.html>`__.
...
yellow.... Compare `blue wire <./B.html#blue-wire.html>`__, `yellow
wire <./Y.html#yellow-wire.html>`__, and `red
wire <./R.html#red-wire.html>`__.
...
1. To put something onto a `stack <./S.html#stack.html>`__. If one says
...
`BSD <./B.html#BSD.html>`__ community's relationship to
`Linux <./L.html#Linux.html>`__ — it's the smaller party in a (usually
...
`Guido <./G.html#Guido.html>`__, `BDFL <./B.html#BDFL.html>`__.
