...
+ ------+                          -------------+
| HHOS               | `ha ha only serious <./H.html#ha-ha-only-serious>`__                                                                                                                                                                                                                                                                                                                                 |
+ ------+                          -------------+
| IMHO               | in my humble opinion (see `IMHO <./I.html#IMHO>`__)                                                                                                                                                                                                                                                                                                                                  |
+ ------+                          -------------+
| LOL                | laughing out loud                                                                                                                                                                                                                                                                                                                                                                       |
+ ------+                          -------------+
| NHOH               | Never Heard of Him/Her (often used in `initgame <./I.html#initgame>`__)                                                                                                                                                                                                                                                                                                              |
+ ------+                          -------------+
...
`bonk/oif <./B.html#bonk-oif>`__) people. The word re by itself is
...
Some `B1FF <./B.html#B1FF>`__\ isms (notably the variant spelling
...
See also `hakspek <./H.html#hakspek>`__,
`emoticon <./E.html#emoticon>`__.
...
`OT <./O.html#OT>`__. A number of hacker-humor synonyms are used for
...
Same as `down <./D.html#down>`__, used primarily by Unix hackers. See
also `hosed <./H.html#hosed>`__. Popularized as a synonym for ‘drunk’
...
`heavyweight <./H.html#heavyweight>`__ technique, or at the poor
quality of some piece of software, or at the `signal-to-noise
ratio <./S.html#signal-to-noise-ratio>`__ of unmoderated Usenet
...
`Appendix B <../appendixb>`__ for discussion).
...
problem <./O.html#one-banana-problem>`__) Also used to dismiss jobs
...
`compress <./C.html#compress>`__). The latter action is dubbed
...
`http://www.nwta.com/Spy/spring99/tar.html <http://www.nwta.com/Spy/spring99/tar>`__.
...
and `flavor <./F.html#flavor>`__ are not. Taste refers to sound
...
`flavor <./F.html#flavor>`__. Also, `flavor <./F.html#flavor>`__
...
debugging <./S.html#shotgun-debugging>`__. Compare
`heisenbug <./H.html#heisenbug>`__. Not to be confused with:
...
`creationism <./C.html#creationism>`__.
...
`EMACS <./E.html#EMACS>`__, to which it was directly ancestral. Noted
for its powerful programming-language-like features and its unspeakably
`hairy <./H.html#hairy>`__ syntax. It is literally the case that
...
`alt <./A.html#alt>`__ or escape (ASCII 0011011) character).

In fact, this very program was used to produce the second, sorted list
from the first list. The first hack at it had a
`bug <./B.html#bug>`__: GLS (the author) had accidentally omitted the
**@** in front of **F^B**, which as anyone can see is clearly the
`Wrong Thing <./W.html#Wrong-Thing>`__. It worked fine the second
...
`EMACS <./E.html#EMACS>`__. Descendants of an early (and somewhat
lobotomized) version adopted by DEC can still be found lurking on VMS
and a couple of crufty `PDP-11 <./P.html#PDP-11>`__ operating
systems, however, and ports of the more advanced MIT versions remain the
focus of some antiquarian interest. See also
`retrocomputing <./R.html#retrocomputing>`__, `write-only
language <./W.html#write-only-language>`__.
...
sending him the `bits <./B.html#bits>`__ to that? Slap on a tee for
me.” From the Unix command tee(1), itself named after a pipe fitting
(see `plumbing <./P.html#plumbing>`__). Can also mean ‘save one for
...
harvester <./A.html#address-harvester>`__; a mail server deliberately
...
sexual interaction between the `VR <./V.html#VR>`__ presences of two
humans. This practice is not yet possible except in the rather limited
form of erotic conversation on `MUD <./M.html#MUD>`__\ s and the
like. The term, however, is widely recognized in the VR community as a
`ha ha only serious <./H.html#ha-ha-only-serious>`__ projection of
...
See also `hot chat <./H.html#hot-chat>`__.
...
A covert `pseudo <./P.html#pseudo>`__, sense 1. An artificial
...
list (see `cypherpunk <./C.html#cypherpunk>`__), and adopted in a
...
`astroturfing <./A.html#astroturfing>`__, `sock
puppet <./S.html#sock-puppet>`__.
...
Calculus <./K.html#Knights-of-the-Lambda-Calculus>`__.
...
`frogging <./F.html#frogging>`__; see also
`sun-stools <./S.html#sun-stools>`__,
`HP-SUX <./H.html#HP-SUX>`__, `Slowlaris <./S.html#Slowlaris>`__.
...
1. Syn. `raster burn <./R.html#raster-burn>`__.
...
[UK] A `wannabee <./W.html#wannabee>`__ or early `larval
stage <./L.html#larval-stage>`__ hacker who spends most of his or her
time wandering the directory tree and writing
`noddy <./N.html#noddy>`__ programs just to get a fix of computer
...
more prevalent. See also `demo <./D.html#demo>`__.
...
See also `CrApTeX <./C.html#CrApTeX>`__.
...
Programming* (see `Knuth <./K.html#Knuth>`__, also
`bible <./B.html#bible>`__). In a manifestation of the typical
...
`English <./E.html#English>`__.

2. Textual material in the mainstream sense; data in ordinary
`ASCII <./A.html#ASCII>`__ or `EBCDIC <./E.html#EBCDIC>`__
representation (see `flat-ASCII <./F.html#flat-ASCII>`__). “Those are
...
‘aTdHvAaNnKcSe’ or abbreviated ‘TIA’. See `net.- <./N.html#net-->`__,
...
The `canonical <./C.html#canonical>`__ first parry in a debate about
a purported bug. The complainant, if unconvinced, is likely to retort
that the bug is then at best a `misfeature <./M.html#misfeature>`__.
See also `feature <./F.html#feature>`__.
...
NSFnet, BITNET, and the virtual UUCP and `Usenet <./U.html#Usenet>`__
...
addresses. See `Internet <./I.html#Internet>`__, `bang
path <./B.html#bang-path>`__, `network
address <./N.html#network-address>`__.
...
`braino <./B.html#braino>`__; see also `brain
fart <./B.html#brain-fart>`__. Compare `mouso <./M.html#mouso>`__.
...
Less clipped variant of `can't happen <./C.html#can-t-happen>`__.
...
`canonical <./C.html#canonical>`__ response is, of course, “But that
trick *never* works!” See `hacker humor <./H.html#hacker-humor>`__.
...
as thrashing. Compare `multitask <./M.html#multitask>`__.
...
Syn. `Vulcan nerve pinch <./V.html#Vulcan-nerve-pinch>`__.
...
`ISP <./I.html#ISP>`__ for the sole purpose of spewing
`spam <./S.html#spam>`__.
...
convention <../p-convention>`__). In LISP, the constant T means
...
dialect of Lisp developed for the `VAX <./V.html#VAX>`__)
...
1. A `jiffy <./J.html#jiffy>`__ (sense 1).
...
causes is `handwave <./H.html#handwave>`__\ d.
...
1. Originally, a team (of `sneaker <./S.html#sneaker>`__\ s) whose
...
`patch <./P.html#patch>`__ entry for an example).

2. Recently, and more generally, any official inspection team or special
`firefighting <./F.html#firefighting>`__ group called in to look at a
problem.

A subset of tiger teams are professional
`cracker <./C.html#cracker>`__\ s, testing the security of military
...
A subspecies of `logic bomb <./L.html#logic-bomb>`__ that is
...
`LISP <./L.html#LISP>`__, first `imagined this
technique <http://www-formal.stanford.edu/jmc/history/timesharing/timesharing>`__
in the late 1950s. The first timesharing operating systems, BBN's
"Little Hospital" and `CTSS <./C.html#CTSS>`__, were deplayed in
...
the `DEC <./D.html#DEC>`__ 10, 11, and `VAX <./V.html#VAX>`__
...
Explosion <./G.html#Great-Internet-Explosion>`__ before the migration
...
cabal <./B.html#backbone-cabal>`__ and `NANA <./N.html#NANA>`__,
...
starting to look a bit like a `dinosaur <./D.html#dinosaur>`__.
...
`QWERTY <./Q.html#QWERTY>`__ keyboard; but older Macs (like pre-PC
...
been reported. See also `YABA <./Y.html#YABA>`__.
...
vocabulary (see esp. `foo <./F.html#foo>`__,
`mung <./M.html#mung>`__, and `frob <./F.html#frob>`__).
...
switch <./S.html#scram-switch>`__\ es located at numerous places
...
`http://tmrc-www.mit.edu/dictionary.html <http://tmrc-www.mit.edu/dictionary>`__.
...
motto of `Perl <./P.html#Perl>`__ is frequently used on newsgroups
...
1. Notionally, to change a `MUD <./M.html#MUD>`__ player into a toad.

2. To permanently and totally exile a player from the MUD. A very
serious action, which can only be done by a MUD
`wizard <./W.html#wizard>`__; often involves a lot of debate among
the other characters first. See also `frog <./F.html#frog>`__,
`FOD <./F.html#FOD>`__.
...
controller <./E.html#elevator-controller>`__).
“\ `DWIM <./D.html#DWIM>`__ for an assembler? That'd be as silly as
...
toaster <./W.html#web-toaster>`__, `video
...
machine <./F.html#firewall-machine>`__ again.” Compare
`fried <./F.html#fried>`__.
...
A `footprint <./F.html#footprint>`__ of especially small size.
...
To change a `bit <./B.html#bit>`__ from whatever state it is in to
...
combination with other tools (see `filter <./F.html#filter>`__,
`plumbing <./P.html#plumbing>`__).
...
grindstone”. See `hack <./H.html#hack>`__.
...
Pearls*, quotes Dick Sites from `DEC <./D.html#DEC>`__ as saying “I'd
...
shell. Compare `avatar <./A.html#avatar>`__.
...
war <./F.html#flame-war>`__, or just as often evolving into a separate
...
offending person is a `newbie <./N.html#newbie>`__, a Microsoft
...
`bottom-post <./B.html#bottom-post>`__.
...
`computron <./C.html#computron>`__\ s for the speaker's preferred
uses. This is not condemnatory, as is `bitty
box <./B.html#bitty-box>`__; toys can at least be fun. It is also
...
general-purpose programming. `Bad Thing <./B.html#Bad-Thing>`__\ s
can result when a toy language is promoted as a general purpose solution
for programming (see `bondage-and-discipline
language <./B.html#bondage-and-discipline-language>`__); the classic
example is `Pascal <./P.html#Pascal>`__. Several moderately
...
(compare `noddy <./N.html#noddy>`__).

2. One for which the effort of initial coding dominates the costs
through its life cycle. See also `noddy <./N.html#noddy>`__.
...
An incredibly `hairy <./H.html#hairy>`__ technique, found in some
`HLL <./H.html#HLL>`__ and program-overlay implementations (e.g., on
...
process. These pieces of `live data <./L.html#live-data>`__ are
...
1. Syn. `back door <./B.html#back-door>`__ — a `Bad
...
Thing <./G.html#Good-Thing>`__\ s with important applications in
...
exception is more common among `HLL <./H.html#HLL>`__ programmers)
...
`system <./S.html#system>`__, sense 1), who use it to distinguish
...
of the family of near-synonyms including `mung <./M.html#mung>`__,
`mangle <./M.html#mangle>`__, `scribble <./S.html#scribble>`__,
and `roach <./R.html#roach>`__.
...
`spiffy <./S.html#spiffy>`__ but
`content-free <./C.html#content-free>`__ documents. Thus, most
`suit <./S.html#suit>`__\ s are tree-killers.
...
Tolkien's *Lord of the Rings*. See also `elvish <./E.html#elvish>`__,
`elder days <./E.html#elder-days>`__, and especially `dead-tree
version <./D.html#dead-tree-version>`__.
...
also `bit <./B.html#bit>`__). Trits arise, for example, in the
context of a `flag <./F.html#flag>`__ that should actually be able to
...
utterly `cretinous <./C.html#cretinous>`__ would have thought of them
already.
...
`nontrivial <./N.html#nontrivial>`__,
...
`PDP-11 <./P.html#PDP-11>`__ assembler and then in barely-structured
early C by the late Joseph Ossanna, modeled after the earlier ROFF which
was in turn modeled after the `Multics <./M.html#Multics>`__ and
`CTSS <./C.html#CTSS>`__ program RUNOFF by Jerome Saltzer (*that*
...
burn <./R.html#raster-burn>`__). Loud music blaring from a stereo
stacked in the corner is optional but recommended. See `larval
stage <./L.html#larval-stage>`__, `hack
mode <./H.html#hack-mode>`__.
...
door <./B.html#back-door>`__, `virus <./V.html#virus>`__,
`worm <./W.html#worm>`__, `phage <./P.html#phage>`__,
`mockingbird <./M.html#mockingbird>`__.
...
posting on `Usenet <./U.html#Usenet>`__ designed to attract
predictable responses or `flame <./F.html#flame>`__\ s; or, the post
itself. Derives from the phrase “trolling for
`newbie <./N.html#newbie>`__\ s” which in turn comes from mainstream
...
he's just a troll.” Compare `kook <./K.html#kook>`__.
...
`bogometer <./B.html#bogometer>`__,
`Indent-o-Meter <./I.html#Indent-o-Meter>`__.
...
[British BBS scene] Synonym for `leech <./L.html#leech>`__, sense 1.
...
true-hacker.” Compare `demigod <./D.html#demigod>`__, oppose
`munchkin <./M.html#munchkin>`__.
...
`bit-paired keyboard <./B.html#bit-paired-keyboard>`__.
...
cookie <./M.html#magic-cookie>`__ generated as part of a record or
...
`BSD <./B.html#BSD>`__ 4.2 distribution. The joke was removed in
...
`droid <./D.html#droid>`__\ s. The [nt]roff source for SunOS 4.1.1
...
as `hook <./H.html#hook>`__\ s for tuning, e.g., by changing
...
use of hardware). See `hot spot <./H.html#hot-spot>`__,
...
language <./B.html#bondage-and-discipline-language>`__.

2. The perennial `holy wars <./H.html#holy-wars>`__ over whether
...
Tux the Penguin is the official emblem of `Linux <./L.html#Linux>`__,
...
Tux <http://www.ao.com/~regan/penguins/tux>`__ and the mock-epic
...
The TOPS-20 operating system by `DEC <./D.html#DEC>`__ — the second
proprietary OS for the PDP-10 — preferred by most PDP-10 hackers over
TOPS-10 (that is, by those who were not `ITS <./I.html#ITS>`__ or
`WAITS <./W.html#WAITS>`__ partisans). TOPS-20 began in 1969 as Bolt,
...
`VAX <./V.html#VAX>`__ architecture and its relatively stodgy VMS OS
...
`VMS <./V.html#VMS>`__, but instead, by the late 1980s, most of the
...
twiddled. Twiddling a switch or `knobs <./K.html#knobs>`__ implies
...
[IRC] Notionally, the area of cyberspace where `IRC <./I.html#IRC>`__
operators live. An `op <./O.html#op>`__ is said to have a “connection
...
2. [UCSC] A `read-only user <./R.html#read-only-user>`__. Also
...
An amount much larger than `N <./N.html#N>`__ but smaller than
`infinity <./I.html#infinity>`__. “I have 2-to-the-"N" things to do
...
“There's a tyop in your posting”. Compare `grilf <./G.html#grilf>`__,
`hing <./H.html#hing>`__.
