...
`Prev <construction.html>`__ 

Chapter 4. Jargon Construction

 `Next <soundalike-slang.html>`__
...
+-----------------------------------+------------------------------+-------------------------------------+
| `Prev <construction.html>`__      | `Up <construction.html>`__   |  `Next <soundalike-slang.html>`__   |
+-----------------------------------+------------------------------+-------------------------------------+
| Chapter 4. Jargon Construction    | `Home <index.html>`__        |  Soundalike Slang                   |
+-----------------------------------+------------------------------+-------------------------------------+
